...
\item [Github:]\MyHref{mydarkgreen}\href{https://github.com/gabx/accelerometers}
...
\newcommand{\julia}{\protect\includegraphics[height=2.5ex,keepaspectratio]{julia3.pdf}}

\newcommand{\knitr}{\protect\includegraphics[height=2.2ex,keepaspectratio]{knitr2.pdf}}
...
\itarrow The features selected for this database come from the accelerometer and gyroscope 
3-axial raw signals \textbf{tAcc-XYZ} and \textbf{tGyro-XYZ}.Then they were filtered 
...
time to obtain Jerk signals (\textbf{tBodyAccJerk-XYZ} and \textbf{tBodyGyroJerk-XYZ}).
